...
.subnet-lower{display:grid;grid-template-columns:minmax(0,.82fr) minmax(0,1.18fr);gap:24px;align-items:start}
...
@media(max-width:1260px){.subnet-layout,.subnet-lower{grid-template-columns:1fr}.subnet-inputs{position:relative;top:auto}.subnet-result-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.subnet-cisco-form{grid-template-columns:repeat(2,minmax(0,1fr))}}
