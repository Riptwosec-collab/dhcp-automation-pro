...
.final-layout-v5 .final-v5-side .credit-wrap{display:block!important;width:100%!important;max-width:none!important;margin:18px 0 0!important;overflow:visible!important}
...
.final-layout-v5 .final-v5-side .theme-switcher{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:6px!important;width:100%!important;margin-top:18px!important;padding:5px!important;visibility:visible!important;opacity:1!important}
.final-layout-v5 .final-v5-side .theme-btn{display:inline-flex!important;align-items:center!important;justify-content:center!important;width:100%!important;min-width:0!important;min-height:42px!important;padding:8px 10px!important;font-size:.82rem!important;white-space:nowrap!important;visibility:visible!important;opacity:1!important;pointer-events:auto!important}
.final-layout-v5 .final-v5-side #guideMenuBtn{display:inline-flex!important;align-items:center!important;justify-content:center!important;width:100%!important;min-height:46px!important;margin-top:12px!important;visibility:visible!important;opacity:1!important;pointer-events:auto!important}
.final-layout-v5 .final-v5-actions{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:10px!important;width:100%!important;margin-top:14px!important}
...
.final-layout-v5 .final-v5-validate p{margin:13px 0 0 61px!important;max-width:36ch!important;font-size:.91rem!important;line-height:1.58!important;overflow-wrap:anywhere!important}
.final-layout-v5 .final-v5-dns{display:grid!important;grid-template-columns:minmax(135px,175px) minmax(0,1fr)!important;align-items:center!important;gap:18px!important}
...
.final-layout-v5 #configPanel>.p-4{display:flex!important;align-items:center!important;flex-wrap:wrap!important;gap:12px 24px!important;min-height:62px!important;padding:13px 21px!important}
...
(() => {
  ...
  function installGuide(side) {
    ...
    if (dialog && network && !space) {
      ...
      space.src = "/assets/usage-guide-gold.webp?v=5";
